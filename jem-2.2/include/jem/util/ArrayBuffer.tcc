...
template <class T>
  ...
  void ArrayBuffer<T>::swap ( ArrayBuffer& rhs )
...
template <class T>
  ...
  inline float ArrayBuffer<T>::getExpansionFactor () const
...
template <class T>
  ...
  inline idx_t ArrayBuffer<T>::capacity () const
...
template <class T>
  ...
  inline idx_t ArrayBuffer<T>::size () const
...
template <class T>
  ...
  inline const Array<T>& ArrayBuffer<T>::getBuffer () const
...
template <class T>
  ...
  inline T* ArrayBuffer<T>::addr () const

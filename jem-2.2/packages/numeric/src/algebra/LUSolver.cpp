...

{
  ...
  if ( a.isContiguous() &&
       scale.stride() + jperm.stride() == JEM_LINT_C(2) )
  {
...

{
  ...
  if ( lu.isContiguous() &&
       lhs.stride() + jperm.stride() == JEM_LINT_C(2) )
  {
...

{
  ...
  if ( lu.isContiguous() &&
       lhs.stride(0) + jperm.stride() == JEM_LINT_C(2) )
  {
...
JEM_IVDEP
    ...
    if ( flopCount > JEM_LINT_C(1000000) )
    {
...
void LUSolver::solve1_
  ...
  ( idx_t                       n,
    ...
    const idx_t*  JEM_RESTRICT  jperm )

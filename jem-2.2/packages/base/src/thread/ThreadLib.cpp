...
Mutex* ThreadLib::Lock_::mutex = NULL;
...
Thread*    ThreadLib::mainThread_  = 0;
int        ThreadLib::nextKey_     = 0;
Thread**   ThreadLib::zombies_     = 0;
...
void ThreadLib::entryPoint ( ThreadStart*  start )
{
  ...
  Native::setThread ( NULL );
  Native::setCache  ( NULL );
}

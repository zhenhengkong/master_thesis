 ...
 * Attention:
 *
 *  Be careful with the outward normal vector of the cohesive
 *  surface !!!
 *
 * Capacities:
 *
 ...
 *   (8) Both linear (4 node) and quadratic (6 node) interface elements
 *       are supported.
 *
 *  Algorithm used:
 *
 ...
 *    (4) The interface elements are then generated and written to
 *        a separate file.
 *
 * Usage:
 *
...
int main ( int argc, char* argv[] )
{
  ...
  // CustomNodeGrouper cm;
// 
  // cm.findTopNodesX0      ( globdat, nn                 );
  // cm.writeNodeGroup      (                             );

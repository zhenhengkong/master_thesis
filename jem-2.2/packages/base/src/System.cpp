...
System::Properties_*  System::Properties_::instance_ = NULL;
...
{
  JEM_PRECHECK2 ( out != NIL, "NULL output stream" );
...
{
  JEM_PRECHECK2 ( r != NIL, "NULL input stream" );
...
{
  JEM_PRECHECK2 ( log != NIL, "NULL logger" );
...
{
  JEM_PRECHECK2 ( func != NULL, "NULL function pointer" );

  int  retval = 0;

  NativeSystem::setSigHandler ( Signals::FP_EXCEPTION,
                                abortOnSignal );
  NativeSystem::setSigHandler ( Signals::MEMORY_ERROR,
                                abortOnSignal );
...
void System::dumpStackTrace ( int offset )
{

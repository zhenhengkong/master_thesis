...
template <class T>
  ...
  inline const DataType& SinkBase<T>::type () const
...
template <class T, int N>
  ...
  inline void* SinkImp<T,N>::addr () const
...
template <class T, int N>
  ...
  inline idx_t SinkImp<T,N>::count () const
...
template <class T>
  ...
  inline void* SinkImp<T,0>::addr () const
...
template <class T>
  ...
  inline idx_t SinkImp<T,0>::count () const
...
template <class T>
  ...
  inline void* SinkImp<T,1>::addr () const
...
template <class T>
  ...
  inline idx_t SinkImp<T,1>::count () const
...
template <class T, int N>
  ...
  inline void* VLSinkImp<T,N>::addr () const
...
template <class T, int N>
  ...
  inline idx_t VLSinkImp<T,N>::count () const
...
template <class T>
  ...
  inline void* VLSinkImp<T,0>::addr () const
...
template <class T>
  ...
  inline idx_t VLSinkImp<T,0>::count () const

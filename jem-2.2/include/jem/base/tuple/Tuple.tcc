...
template <class T, int M, int N>
  ...
  inline T* Tuple<T,M,N,Nil>::begin ()
...
template <class T, int M, int N>
  ...
  inline const T* Tuple<T,M,N,Nil>::begin () const
...
template <class T, int M, int N>
  ...
  inline const T* Tuple<T,M,N,Nil>::end () const
...
template <class T, int M, int N>
  ...
  inline const T* Tuple<T,M,N,Nil>::addr () const
...

{
 public:
  ...
  static const bool   HAS_TRIVIAL_CTOR = HasTrivialCtor<T>::VALUE;
  static const bool   HAS_TRIVIAL_COPY = HasTrivialCopy<T>::VALUE;
  static const bool   HAS_TRIVIAL_DTOR = HasTrivialDtor<T>::VALUE;

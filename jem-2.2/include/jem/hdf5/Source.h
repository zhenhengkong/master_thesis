...
template <class T>
  ...
  inline const DataType& SourceBase<T>::type () const
...
template <class T, int N>
  ...
  inline const void* SourceImp<T,N>::addr () const
...
template <class T, int N>
  ...
  inline idx_t SourceImp<T,N>::count () const
...
template <class T>
  ...
  inline const void* SourceImp<T,0>::addr () const
...
template <class T>
  ...
  inline idx_t SourceImp<T,0>::count () const
...
template <class T>
  ...
  inline const void* SourceImp<T,1>::addr () const
...
template <class T>
  ...
  inline idx_t SourceImp<T,1>::count () const
...
template <class T, int N>
  ...
  inline const void* VLSourceImp<T,N>::addr () const
...
template <class T, int N>
  ...
  inline idx_t VLSourceImp<T,N>::count () const
...
template <class T>
  ...
  inline const void* VLSourceImp<T,0>::addr () const
...
template <class T>
  ...
  inline idx_t VLSourceImp<T,0>::count () const

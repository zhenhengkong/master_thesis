...
class DOMElement : public Object
{
 public:
  ...
  bool                      isEmpty         () const;
  inline DOMElement*        getParent       () const;
  inline idx_t              childCount      () const;
...
inline bool DOMElement::isRoot () const
{
  return (parent_ == 0);
}
...
inline bool DOMElement::isText () const
{
...
inline bool DOMElement::isData () const
{
...
inline DOMElement* DOMElement::getParent () const
{
  return parent_;
}
...
inline idx_t DOMElement::childCount () const
{

...
inline idx_t SparseILUd::size () const
{
  return size_;
}
...
inline idx_t SparseILUd::nonZeroCount () const
{
...
inline double SparseILUd::getDropTol () const
{
  return droptol_;
}
...
inline double SparseILUd::getDiagShift () const
{
  return dshift_;
}

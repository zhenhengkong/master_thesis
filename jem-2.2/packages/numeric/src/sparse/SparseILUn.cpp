...
double SparseILUn::getMemUsage () const
{
...

{
  ...
  idx_t*         JEM_RESTRICT  indexPtr  = NULL;
  idx_t*         JEM_RESTRICT  levelPtr  = NULL;
  double*        JEM_RESTRICT  valuePtr  = NULL;
  idx_t*         JEM_RESTRICT  levls     = NULL;
  idx_t*         JEM_RESTRICT  jcols     = NULL;
  idx_t*         JEM_RESTRICT  jlist     = NULL;
  idx_t*         JEM_RESTRICT  itags     = NULL;

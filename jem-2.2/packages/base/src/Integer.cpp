...
const lint  Integer::MIN_VALUE = JEM_LINT_MIN;
const lint  Integer::MAX_VALUE = JEM_LINT_MAX;
...

{
  ...
  if ( itmp < (lint) INT_MIN || itmp > (lint) INT_MAX )
  {
    return false;
  }
...

{
  ...
  {
    quot     = value / base;
    buf[j++] = digits[ ::labs( value - quot * base ) ];
    value    = quot;
  }

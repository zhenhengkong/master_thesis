...
inline bool testSignBit ( byte b )
{
...

{
 public:
  ...
  static inline void copy  ( byte*, const byte* )
  {}

  static inline void rcopy ( byte*, const byte* )
  {}

  static inline void set   ( byte*, byte )
  {}
...

{
 public:
  ...
  static inline void copy ( byte* dest, const byte* src )
  {
    dest[0] = src[0];
    dest[1] = src[1];
  }

  static inline void rcopy ( byte* dest, const byte* src )
  {
    dest[0] = src[1];
    dest[1] = src[0];
  }

  static inline void set ( byte* buf, byte b )
  {
    buf[0] = b;
    buf[1] = b;
  }
...

{
 public:
  ...
  static inline void encode ( byte* buf, const T& value )
  {
    if ( value < 0 )
    {
  ...
  static inline void decode ( T& value, const byte* buf )
  {
    ByteArray<Traits::NATIVE_SIZE>::copy (
...

{
 public:
  ...
  static inline void encode ( byte* buf, const bool& value )
  {
    if ( value )
    {
      *buf = (byte) 255;
  ...
  static inline void decode ( bool& value, const byte* buf )
  {
    if ( *buf )
    {
      value = true;
...

{
 public:
  ...
  static inline void encode ( byte* buf, const byte& value )
  {
    *buf = value;
  }

  static inline void decode ( byte& value, const byte* buf )
  {
    value = *buf;
  }
...

{
 public:
  ...
  static inline void encode ( byte* buf, const char& value )
  {
    *buf = (byte) value;
  }

  static inline void decode ( char& value, const byte* buf )
  {
    value = (char) *buf;
  }
...
template <class T>
  ...
  inline void encode ( byte* buf, const T& value, int sex )
...
template <class T>
  ...
  void encode ( byte* buf, const T* values, idx_t n, int sex )
...
template <class T>
  ...
  inline void decode ( T& value, const byte* buf, int sex )
...
template <class T>
  ...
  void decode ( T* values, idx_t n, const byte* buf, int sex )

...
inline bool DOMParser::Element_::isRoot () const
{
  return (parent_ == NIL);
}
...
inline bool DOMParser::Element_::isLeaf () const
{
...
const int    DOMParser::PARSE_ATTRIBS_  = 1 << 0;
const int    DOMParser::PARSE_TO_UPPER_ = 1 << 1;
const int    DOMParser::PARSE_TO_LOWER_ = 1 << 2;
const int    DOMParser::SKIP_CONTENTS_  = 1 << 3;
...
Ref<DOMElement> DOMParser::getRootElement ()
{
  Ref<DOMElement>  root;

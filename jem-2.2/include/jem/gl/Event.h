...
class GfxEvent
{
 public:
  ...
  inline GfxEvent*          next      () const;
  inline GfxEvent*          prev      () const;
  inline void               unlink    ();
...
inline GfxEvent::GfxEvent () : type ( NOP )
{
  next_ = prev_ = this;
}


inline GfxEvent::GfxEvent ( TypeID t ) : type ( t )
{
  next_ = prev_ = this;
}
...
inline GfxEvent* GfxEvent::next () const
{
  return next_;
}


inline GfxEvent* GfxEvent::prev () const
{
  return prev_;
}
...
inline RedrawEvent::RedrawEvent () : Super ( REDRAW )
{
  flags = 0;
}
...
inline ResizeEvent::ResizeEvent () : Super ( RESIZE )
{}
...
inline InitEvent::InitEvent () : Super ( INIT )
{}

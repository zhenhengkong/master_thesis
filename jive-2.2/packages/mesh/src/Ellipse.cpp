...
{
  JEM_PRECHECK ( mesh != NIL && params.isValid() );
...

{
  ...
  stripCount =       max ( JEM_IDX_C(1), (idx_t)
                           (xradius / delta + 0.5) );
...

{
  ...
  const bool    mkGroups  = (params.nodeGroups != NIL);

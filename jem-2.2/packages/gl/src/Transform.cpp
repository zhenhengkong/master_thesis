...
GLdouble Transform::getScale () const
{
...
void Transform::rotate ( GLdouble  a )
{
...
void Transform::setRotation ( GLdouble a )
{
  GLdouble*  JEM_RESTRICT  tr = data_;
...
void Transform::transform ( const Transform& tr )
{
  Transform  self = *this;
...
Transform Transform::rotation ( GLdouble a )
{
  Transform  rot;
...
void getCurrent ( Transform& tr )
{
  ...
  if      ( mmode == GL_MODELVIEW )
  {
    ::glGetDoublev ( GL_MODELVIEW_MATRIX,  tr.addr() );
  }
  else if ( mmode == GL_PROJECTION )
  {
    ::glGetDoublev ( GL_PROJECTION_MATRIX, tr.addr() );
  }
  else if ( mmode == GL_TEXTURE )
  {
    ::glGetDoublev ( GL_TEXTURE_MATRIX,    tr.addr() );
  }
  else
  {
    throw Error ( JEM_FUNC,
                  "unknown matrix mode: " + String( mmode ) );
  }
}

...
class BodyDataComputer
{
 public:
  ...
  static const idx_t      LO_PREC = 1;
  static const idx_t      HI_PREC = 2;
...

{
  ...
  maxPrec_ = jem::min ( HI_PREC, shapes.maxPrecision() );

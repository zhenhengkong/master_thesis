...
class GraphViewer::DataSet_ : public Object, public DataSet
{
 public:
  ...
  virtual idx_t             getMaxPoints    () const;
  ...
  virtual GLfloat           getLineWidth    () const;
  ...
  virtual PntStyle*         getPointStyle   () const;
...
const int  GraphViewer::SHOW_KEY        = XYPlot::SHOW_KEY;
const int  GraphViewer::SHOW_XTICKS     = XYPlot::SHOW_XTICKS;
const int  GraphViewer::SHOW_YTICKS     = XYPlot::SHOW_YTICKS;
const int  GraphViewer::SHOW_TICKS      = XYPlot::SHOW_TICKS;
const int  GraphViewer::DEFAULT_OPTIONS = XYPlot::DEFAULT_OPTIONS;

const int  GraphViewer::LINES           = XYPlot::LINES;
const int  GraphViewer::POINTS          = XYPlot::POINTS;
const int  GraphViewer::LINES_POINTS    = XYPlot::LINES_POINTS;
...
void GraphViewer::setOptions ( int options )
{
  WriteLock_  lock ( this );
...
int GraphViewer::getOptions () const
{
  ReadLock_  lock ( this );
...

{
  if ( mouse.button == Buttons::LEFT )
  {
    ...
    {
      showMousePos_ ( gtx, mouse.x, mouse.y );
    }
  }
...

{
  ...
  else
  {
    ...
    postRedraw =
      ...
      window_->takeGLAction ( gtx, GLActions::EXE_COMMAND, params );
  }

  if ( postRedraw )
  {
    gtx.postFastRedraw ( window_ );
  }
}
...

{
  ...
  if ( fromWindowToNode( u, *plot_ ) &&
       fromWindowToNode( v, *plot_ ) )
  {
...
void GraphViewer::showMenu_ ( GfxContext& gtx )
{
  using jem::util::connect;

...
template <class T>
  ...
  void SparseMatrix<T>::swap ( SparseMatrix& rhs )
...
template <class T>
  ...
  inline bool SparseMatrix<T>::isValid () const
...
template <class T>
  ...
  inline bool SparseMatrix<T>::isSorted () const
...
template <class T>
  ...
  inline bool SparseMatrix<T>::isContiguous () const
...
template <class T>
  ...
  inline SparseStructure SparseMatrix<T>::getStructure () const
...
template <class T>
  ...
  inline idx_t SparseMatrix<T>::nonZeroCount () const
...
template <class T>
  ...
  SparseMatrix<T>::getRowOffsets () const
...
template <class T>
  ...
  inline const Array<idx_t>&
  SparseMatrix<T>::getColumnIndices () const
...
template <class T>
  ...
  inline const Array<T>& SparseMatrix<T>::getValues () const
...
template <class T>
  ...
  inline const idx_t* SparseMatrix<T>::getOffsetPtr () const
...
template <class T>
  ...
  inline const idx_t* SparseMatrix<T>::getIndexPtr () const
...
template <class T>
  ...
  inline T* SparseMatrix<T>::getValuePtr () const

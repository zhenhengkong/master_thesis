...
template <class T>
  ...
  inline MatmulChain<T,0>::MatmulChain ()
...
template <class T>
  ...
  inline MatmulChain<T,1>::MatmulChain ()
...
template <class T>
  ...
  inline MatmulChain<T,2>::MatmulChain ()
...

{
  ...
  if ( b.stride(0) == JEM_IDX_C(1) && b.stride(1) == n )
  {
    bcol = b.addr ();
  }
  else
...
template <class T>
  ...
  inline MatmulChain<T,3>::MatmulChain ()
...

{
  ...
  if ( c.stride(0) == JEM_IDX_C(1) && c.stride(1) == p )
  {
    ccol = c.addr ();
  }
  else
...
template <class T>
  ...
  inline MatmulChain<T,4>::MatmulChain ()
...

{
  ...
  if ( d.stride(0) == JEM_IDX_C(1) && d.stride(1) == q )
  {
    dcol = d.addr ();
  }
  else

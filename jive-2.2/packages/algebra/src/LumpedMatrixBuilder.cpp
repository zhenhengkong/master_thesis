...
const int    LumpedMatrixBuilder::AUTO_RESHAPE = 1 << 0;
...
{
  JEM_PRECHECK2 ( mat != NIL, "NULL DiagMatrixObject" );
...
int LumpedMatrixBuilder::setOptions ( int options )
{
  Data_&  d    = * data_;
...
int LumpedMatrixBuilder::getOptions () const
{

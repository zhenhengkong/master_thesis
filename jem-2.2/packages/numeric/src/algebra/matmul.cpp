...

{
  ...
  if ( a.stride(0) > a.stride(1) )
  {
    ...
    if ( a.stride(1) + b.stride() == JEM_IDX_C(2) )
    {
      const double* JEM_RESTRICT  arow1 = NULL;
      const double* JEM_RESTRICT  arow2 = NULL;
      const double* JEM_RESTRICT  arow3 = NULL;
  ...
  else
  {
    ...
    if ( a.stride(0) + r.stride() == JEM_IDX_C(2) )
    {
      const double* JEM_RESTRICT  acol1 = NULL;
      const double* JEM_RESTRICT  acol2 = NULL;
      const double* JEM_RESTRICT  acol3 = NULL;
...

{
  ...
  if ( b.stride(0) > b.stride(1) )
  {
    ...
    if ( b.stride(1) + r.stride() == JEM_IDX_C(2) )
    {
...
JEM_IVDEP
  ...
  else
  {
    ...
    if ( a.stride() + b.stride(0) == JEM_IDX_C(2) )
    {
...

{
  ...
  if ( r.stride(0) > r.stride(1) )
  {
    ...
    if ( b.stride() + r.stride(1) == JEM_IDX_C(2) )
    {
      for ( i = 0; i < m; i++ )
      {
        a0 = a[i];
  ...
  else
  {
    ...
    if ( a.stride() + r.stride(0) == JEM_IDX_C(2) )
    {
      for ( j = 0; j < n; j++ )
      {
        b0 = b[j];
...

{
  ...
  if ( a.stride(0) > a.stride(1) )
  {
    ...
    if ( a.stride(1) + b.stride(0) == JEM_IDX_C(2) )
    {
      ...
      const double* JEM_RESTRICT  arow2 = NULL;
      const double* JEM_RESTRICT  arow3 = NULL;
      const double* JEM_RESTRICT  bcol1 = NULL;
      const double* JEM_RESTRICT  bcol2 = NULL;
      const double* JEM_RESTRICT  bcol3 = NULL;
  ...
  else
  {
    ...
    if ( r.stride(0) + a.stride(0) == JEM_IDX_C(2) )
    {
      ...
      const double* JEM_RESTRICT  acol2 = NULL;
      const double* JEM_RESTRICT  acol3 = NULL;
      double*       JEM_RESTRICT  rcol1 = NULL;
      double*       JEM_RESTRICT  rcol2 = NULL;
      double*       JEM_RESTRICT  rcol3 = NULL;

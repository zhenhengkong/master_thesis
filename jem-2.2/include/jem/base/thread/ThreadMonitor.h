...
inline byte ThreadMonitor::getSignal () const
{
  return signal_;
}
...
inline void ThreadMonitor::clearSignal ( byte sigmask )
{
  signal_ = (byte) (signal_ & (~sigmask));
}
...
inline byte ThreadMonitor::getSigmask () const
{
  return sigmask_;
}
...
inline byte ThreadMonitor::setSigmask ( byte sigmask )
{
  byte  tmp = sigmask_;

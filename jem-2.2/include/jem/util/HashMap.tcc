...
template <class K, class V, class A>
  ...
  inline void HashMap<K,V,A>::swap ( HashMap& rhs )
...
template <class K, class V, class A>
  ...
  inline idx_t HashMap<K,V,A>::capacity () const
...
template <class K, class V, class A>
  ...
  inline idx_t HashMap<K,V,A>::size () const

...
template <class T, int N>
  ...
  inline Array<T,N,Nil>::Array ( const Array& rhs ) :
...
template <class T, int N>
  ...
  void Array<T,N,Nil>::swap ( Array& rhs )
...
template <class T, int N>
  ...
  inline T& Array<T,N,Nil>::getFast ( idx_t i ) const
...
template <class T, int N>
  ...
  inline bool Array<T,N,Nil>::isAllocated () const
...
template <class T, int N>
  ...
  inline bool Array<T,N,Nil>::isContiguous () const
...
template <class T, int N>
  ...
  inline T* Array<T,N,Nil>::addr () const
...
template <class T, int N>
  ...
  Array<T,N,Nil>::getDataBlock () const
...

{
  ...
  if ( st > JEM_IDX_C(1) )
  {
    shape_[idim] = (shape_[idim] + st - JEM_IDX_C(1)) / st;
  }
}
...
template <class T>
  ...
  inline Array<T,1,Nil>::Array ( const Array& rhs ) :
...
template <class T>
  ...
  Array<T,1,Nil>::begin () const

{
  return Iterator ( data_, JEM_IDX_C(0), stride_ );
}
...
template <class T>
  ...
  void Array<T,1,Nil>::swap ( Array& rhs )
...
template <class T>
  ...
  inline T& Array<T,1,Nil>::getFast ( idx_t i ) const
...
template <class T>
  ...
  inline bool Array<T,1,Nil>::isAllocated () const
...
template <class T>
  ...
  inline bool Array<T,1,Nil>::isContiguous () const

{
  return (stride_ == JEM_IDX_C(1));
}
...
template <class T>
  ...
  inline idx_t Array<T,1,Nil>::size () const
...
template <class T>
  ...
  inline idx_t Array<T,1,Nil>::stride () const
...
template <class T>
  ...
  inline T* Array<T,1,Nil>::addr () const

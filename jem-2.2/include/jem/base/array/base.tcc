...

{
  return ( ((stride[0] - JEM_IDX_C(1)) |
            (stride[1] - shape[0])     |
            (stride[2] - shape[1] * stride[1])) == JEM_IDX_C(0) );
}
...

{
  return ( ((stride[0] - JEM_IDX_C(1))         |
            ...
            (stride[3] - shape[2] * stride[2])) == JEM_IDX_C(0) );
}
...
{
  return ( ((int) (shape[0] < JEM_IDX_C(0)) |
            (int) (shape[1] < JEM_IDX_C(0))) == 0 );
}
...
{
  return ( ((int) (shape[0] < JEM_IDX_C(0)) |
            (int) (shape[1] < JEM_IDX_C(0)) |
            (int) (shape[2] < JEM_IDX_C(0))) == 0 );
}
...

{
  return ( ((int) (shape[0] < JEM_IDX_C(0)) |
            (int) (shape[1] < JEM_IDX_C(0)) |
            (int) (shape[2] < JEM_IDX_C(0)) |
            (int) (shape[3] < JEM_IDX_C(0))) == 0 );
}

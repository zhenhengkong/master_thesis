...
template <class T, class A>
  ...
  inline void HashSet<T,A>::swap ( HashSet& rhs )
...
template <class T, class A>
  ...
  inline idx_t HashSet<T,A>::capacity () const
...
template <class T, class A>
  ...
  inline idx_t HashSet<T,A>::size () const

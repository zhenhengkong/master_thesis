...
void Optable::init ()
{
  ...
  Utils_::initIntegralHandlers ( (byte*)      0 );
  Utils_::initIntegralHandlers ( (char*)      0 );
  Utils_::initIntegralHandlers ( (short*)     0 );
  Utils_::initIntegralHandlers ( (int*)       0 );
  Utils_::initIntegralHandlers ( (lint*)      0 );
  Utils_::initFloatHandlers    ( (float*)     0 );
  Utils_::initFloatHandlers    ( (double*)    0 );
  Utils_::initPairHandlers     ( (IntPair*)   0 );
  Utils_::initPairHandlers     ( (DoubleInt*) 0 );
}

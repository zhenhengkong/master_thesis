...
const int    FlexMatrixBuilder::AUTO_SHAPE0  = 1 << 0;
const int    FlexMatrixBuilder::AUTO_SHAPE1  = 1 << 1;

const int    FlexMatrixBuilder::AUTO_RESHAPE = (AUTO_SHAPE0 |
                                                AUTO_SHAPE1);

const int    FlexMatrixBuilder::DROP_ZEROES  = 1 << 2;
...
int FlexMatrixBuilder::setOptions ( int options )
{
  Data_&  d    = * data_;
  int     itmp = data_->options;
...
int FlexMatrixBuilder::getOptions () const
{

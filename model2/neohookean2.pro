  ...
  model       =
  {
    ...
    interface =   // model for stiffness matrix from interface
    {
      ...
      coheMat =
      {
        ...
        f2t = 10.;          // tensile strength 20
        f6  = 10.;          // shear strength  20
...
//      dispIncr = 0.1;      // (initial) displacement increment size
//      minDispIncr = 0.1;// minimum displacement increment

//      maxDisp = 20.;         // displacement value for termination

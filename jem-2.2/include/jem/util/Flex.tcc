...
template <class T>
  ...
  inline typename Flex<T>::Iterator Flex<T>::begin ()
...
template <class T>
  ...
  inline typename Flex<T>::ConstIterator Flex<T>::begin () const
...
template <class T>
  ...
  inline typename Flex<T>::Iterator Flex<T>::end ()
...
template <class T>
  ...
  inline typename Flex<T>::ConstIterator Flex<T>::end () const
...
template <class T>
  ...
  void Flex<T>::pushBack ( T item, idx_t n )
...
template <class T>
  ...
  inline float Flex<T>::getExpansionFactor () const
...
template <class T>
  ...
  inline idx_t Flex<T>::capacity () const
...
template <class T>
  ...
  inline idx_t Flex<T>::size () const
...
template <class T>
  ...
  inline const T* Flex<T>::addr ( idx_t i ) const

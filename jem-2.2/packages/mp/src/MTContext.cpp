...
{
  const int    ACTION = ReduceAction::BARRIER;
...

{
  ...
  const int            ACTION = ReduceAction::REDUCE;
...
{
  const int          ACTION = ReduceAction::ALLREDUCE;
...
{
  const int            ACTION = ReduceAction::BCAST;

...
const int  Tokenizer::PARSE_COMMENTS       = 1 << 0;
const int  Tokenizer::PARSE_SYMBOLS        = 1 << 1;
const int  Tokenizer::PARSE_STRINGS        = 1 << 2;
const int  Tokenizer::PARSE_BOOLEANS       = 1 << 3;
const int  Tokenizer::PARSE_NUMBERS        = 1 << 4;
const int  Tokenizer::PARSE_SIGNED_NUMBERS = 1 << 5;
const int  Tokenizer::PARSE_OPERATORS      = 1 << 6;

const int  Tokenizer::CATENATE_STRINGS     = 1 << 7;
...
void Tokenizer::setOptions ( int options )
{
  options_ = options;
...
int Tokenizer::getOptions () const
{
  return options_;
}

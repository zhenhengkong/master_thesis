...
const int  SparseMatrixObject::SYMMETRIC       = 1 << 0;

// Options:

const int  SparseMatrixObject::ENABLE_BLOCKING = 1 << 0;
...
void SparseMatrixObject::setOptions ( int options )
{
...
void SparseMatrixObject::packValues_ ()
{
  ...
  const double* JEM_RESTRICT  matValues  = matValues_ .addr ();
  double*       JEM_RESTRICT  supValues  = NULL;

  const double* JEM_RESTRICT  mp = NULL;
  double*       JEM_RESTRICT  sp = NULL;
...
void SparseMatrixObject::initSuperRows_ ()
{
  ...
  const idx_t*    JEM_RESTRICT  iptr = NULL;
  const idx_t*    JEM_RESTRICT  jptr = NULL;
...

{
  ...
  const double* JEM_RESTRICT  sp = NULL;

...
inline idx_t StringBuffer::size () const
{
  return size_;
}
...
inline idx_t StringBuffer::capacity () const
{
  return str_.size_;
}
...
inline const char* StringBuffer::begin () const
{
  return addr ();
}
...
inline const char* StringBuffer::end () const
{
  return addr() + size_;
}
...
inline const char* StringBuffer::addr () const
{
  return str_.cstr_;
}

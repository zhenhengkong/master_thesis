...
inline idx_t SparseILUn::size () const
{
  return size_;
}
...
inline idx_t SparseILUn::nonZeroCount () const
{
...
inline double SparseILUn::getDropTol () const
{
  return droptol_;
}
...
inline double SparseILUn::getDiagShift () const
{
  return dshift_;
}

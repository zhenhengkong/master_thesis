...
inline bool DOMIterator::operator != ( const Self& rhs ) const
{
  return ! operator == ( rhs );
}
...
inline DOMElement* DOMIterator::get () const
{
  return elem_;
}
...
inline int DOMIterator::dir () const
{
  return dir_;
}
...
inline int DOMIterator::depth () const
{
  return depth_;
}

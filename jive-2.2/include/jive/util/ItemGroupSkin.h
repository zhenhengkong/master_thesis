...
inline ItemGroupSkin::ItemGroupSkin ( const Ref<Data>& data ) :
...
inline ItemGroupSkin::ItemGroupSkin ( const Self& rhs ) :
...
inline bool ItemGroupSkin::operator == ( const Self& rhs ) const
{
  return (data_ == rhs.data_);
}


inline bool ItemGroupSkin::operator == ( const Nil& rhs ) const
{
  return (data_ == rhs);
}
...
inline ItemGroupSkin::Data* ItemGroupSkin::getData () const
{
  return data_.get ();
}
...
inline void ItemGroupSkin::swap_ ( Self& rhs )
{

...
{
  JEM_PRECHECK2 ( xshape != NIL && xshape->shapeFuncCount() == 2,
...
{
  JEM_PRECHECK2 ( xfuncs != NIL  &&
                  xfuncs->getGeometry() == GEOMETRY,
                  "invalid geometric shape functions" );
  JEM_PRECHECK2 ( sfuncs == NIL  ||
...

{
  ...
  Ref<SShape>  sshape = ( sfuncs != NIL ) ? sfuncs : xshape;

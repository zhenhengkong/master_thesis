...
class WeakHashMap::Enumerator_ : public MapEnumerator
{
 public:
  ...
  virtual void            toNext        ();
  virtual Ref<Object>     getKey        () const;
  virtual Ref<Object>     getValue      () const;
...

{
  ...
  map_->enumCount_.incr ();
}


WeakHashMap::Enumerator_::~Enumerator_ ()
{
  map_->enumCount_.decr ();
}

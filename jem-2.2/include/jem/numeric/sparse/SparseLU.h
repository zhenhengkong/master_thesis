...
class SparseLU : public SparseSolver
{
 public:
  ...
  inline idx_t                getMaxZeroPivots  () const;

  void                        setPivotThreshold

    ( double                    alpha );

  inline double               getPivotThreshold () const;
...
inline idx_t SparseLU::size () const
{
  return size_;
}
...
inline idx_t SparseLU::nonZeroCount () const
{
...
inline idx_t SparseLU::getMaxZeroPivots () const
{
...
inline double SparseLU::getPivotThreshold () const
{
